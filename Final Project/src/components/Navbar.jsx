...
export default function Navbar() {
  ...
  const renderMobileMenu = (
    ...
    >
      ...
      <MenuItem onClick={() => {navigate('advertisements') 
        handleMobileMenuClose()}}>
        <p>Advertisements</p>
      </MenuItem>
      ...
      {!user ? <MenuItem onClick={() => {navigate('/Register')
        handleMobileMenuClose()}}>
        <p>Register</p>
      </MenuItem> : <></>}
      {user ? <MenuItem onClick={() => {erase()
        navigate('/Login')
        handleMobileMenuClose()}}>
        <p>Log out</p>
      </MenuItem> : <></>}
    ...
    <Box sx={{ flexGrow: 1 }}>
      <AppBar position="static" style={{backgroundColor: 'red'}}>
        <Toolbar>
          ...
          <Button variant="text" style={{backgroundColor: 'green'}}  sx={{ color: 'white' }} onClick={()=>navigate("/advertisement-form")}>New Advertisement</ Button>
          {/* <Autocomplete 
            id="search"
            freeSolo
            options={[]}
